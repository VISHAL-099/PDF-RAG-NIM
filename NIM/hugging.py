...
# Streamlit app title
st.title("RAG Application: Document Retrieval and Querying")
...
if prompt1:
    if "vectors" not in st.session_state:
        ...
        try:
            ...
            llm = ChatOpenAI(model="gpt-4o", temperature=0, openai_api_key="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")  # Use temperature=0 for deterministic responses
